...
type Addon_Type = Addon_BaseType | Addon_PageType | Addon_WrapperType | Addon_SidebarBottomType | Addon_SidebarTopType | Addon_TestProviderType;
...
interface Addon_TestProviderType<Details extends {
    ...
    mapStatusUpdate?: (state: Addon_TestProviderState<Details>) => API_StatusUpdate | ((state: API_StatusState) => API_StatusUpdate);
    runnable?: boolean;
    watchable?: boolean;
}
type Addon_TestProviderState<Details extends {
    [key: string]: any;
} = NonNullable<unknown>> = Pick<Addon_TestProviderType, 'runnable' | 'watchable'> & {
