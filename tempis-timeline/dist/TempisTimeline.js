...
const TimelineDataSet_1 = require("./TimelineDataSet");
const TimelineDataView_1 = require("./TimelineDataView");
const TimelineFont_1 = require("./TimelineFont");
const TimelineRangeView_1 = require("./TimelineRangeView");
class TempisTimeline {
    ...
    constructor(context, options) {
        ...
        this._rangeView = new TimelineRangeView_1.TimelineRangeView(this._canvas, this._options.range);
        this._dataSet = new TimelineDataSet_1.TimelineDataSet(() => this._onDataSetChange());
        this._dataView = new TimelineDataView_1.TimelineDataView(this._dataSet);
        this._font = new TimelineFont_1.TimelineFont((_a = this._options.style) === null || _a === void 0 ? void 0 : _a.font);
